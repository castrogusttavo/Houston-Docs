          ...
          <div className="relative md:w-64 min-w-[200px]">
            <div className="relative flex items-center text-grey-800 dark:text-grey-300">
              <input
                ...
                className="block w-full appearance-none rounded-lg px-3 py-2 transition-colors text-base leading-tight md:text-sm bg-slate-100 dark:bg-grey-50/10 focus:bg-slate-100/50 dark:focus:bg-grey-50/5 focus:outline-none focus:border-none focus:ring-2 focus:ring-ring focus:ring-offset-background focus:ring-softis-light dark:focus:ring-softis-dark placeholder:text-grey-400 dark:placeholder:text-grey-200 text-grey-400 dark:text-grey-200"
                value={dataSearch}
