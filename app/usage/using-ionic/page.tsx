...
export default function IonicUsagePage() {
  return (
    <div className="bg-slate-50 dark:bg-zinc-950 dark:text-zinc-50 antialiased font-sans min-h-screen transition-[grid-template-columns] duration-300 ease-in-out">
      ...
      <div className="mx-auto flex max-w-[90rem]">
        <SideBar />
        <Article>
          <Breadcrumbs crumbs={['Usage', 'Using Ionic']} />
          <H1 id="using-ionic">
            Using Ionic <Anchor href="#using-ionic" />
          </H1>
          <Paragraph>
            Integrating Houston Icons into your Ionic project is
            straightforward. This page will guide you through the process of
            using Houston Icons Ionic components in your application.
          </Paragraph>
          ...
          <Paragraph>
            To render an icon, simply use it as a Ionic component:
          </Paragraph>
          <CodeBlock>
            <CodeLine>
              <span className="text-grey-800 dark:text-white">
          ...
          <Paragraph>
            ...
            in your Ionic application, enhancing your project&apos;s design with
            beautiful icons.
          </Paragraph>
          <Paragraph>
            This guide covers the basics of using the Houston Icons package with
            Ionic: installation, importing, rendering, and customizing icons.
            Adjust the code examples to fit the exact syntax and usage patterns
            of the <Code>@houstonicons/ionic</Code> package.
          </Paragraph>
          <DateBlock dateTime="Oct, 09, 2024">Oct, 09, 2024</DateBlock>
          <Pagination>
            <PaginationButton href="/usage/using-angular" orientation="left">
              Using Angular
            </PaginationButton>
            <PaginationButton
