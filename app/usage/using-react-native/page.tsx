...
export default function ReactNativeUsagePage() {
  return (
    <div className="bg-slate-50 dark:bg-zinc-950 dark:text-zinc-50 antialiased font-sans min-h-screen transition-[grid-template-columns] duration-300 ease-in-out">
      ...
      <div className="mx-auto flex max-w-[90rem]">
        <SideBar />
        <Article>
          <Breadcrumbs crumbs={['Usage', 'Using React Native']} />
          <H1 id="using-react-native">
            Using React Native <Anchor href="#using-react-native" />
          </H1>
          <Paragraph>
            Integrating Houston Icons into your React Native project is
            straightforward. This page will guide you through the process of
            using Houston Icons React Native components in your application.
          </Paragraph>
          <H2 id="import-an-icon">
            Import an Icon <Anchor href="#import-an-icon" />
          </H2>
          <Paragraph>
            Once installed, you can import icons directly into your React Native
            components:
          </Paragraph>
          <CodeBlock>
            <CodeLine>
          ...
          <Paragraph>
            ...
            in your React Native application, enhancing your project&apos;s
            design with beautiful icons.
          </Paragraph>
          <Paragraph>
            This guide covers the basics of using the Houston Icons package with
            React Native: installation, importing, rendering, and customizing
            icons. Adjust the code examples to fit the exact syntax and usage
            patterns of the <Code>@houstonicons/react-native</Code> package.
          </Paragraph>
          <DateBlock dateTime="Oct, 09, 2024">Oct, 09, 2024</DateBlock>
          <Pagination>
            <PaginationButton href="/usage/using-ionic" orientation="left">
              Using Ionic
            </PaginationButton>
            <PaginationButton href="/features/autocomplete" orientation="right">
              Autocomplete
            </PaginationButton>
          </Pagination>
        </Article>
